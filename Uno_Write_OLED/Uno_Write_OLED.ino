...
void loop()
{
  ...
  SeeedGrayOled.clearDisplay();                  //  clear the screen and set start position to top left corner
  //Draw binary Bitmap
  SeeedGrayOled.drawBitmap((unsigned char*)SeeedLogo,96*96/8);   //  Draw binary Bitmap (96 pixels *96 pixels  / 8) bytes
  delay(10000);  
  
  setDisplayToOriginalState();  
  SeeedGrayOled.setInverseDisplay();             // Set Display to inverse mode  
  SeeedGrayOled.clearDisplay();                  //  clear the screen and set start position to top left corner
  SeeedGrayOled.drawBitmap((unsigned char*)SeeedLogo,96*96/8);   // (96 pixels *96 pixels  / 8) bytes
  delay(10000);    
  ...
  SeeedGrayOled.setHorizontalScrollProperties(Scroll_Right,72,96,0,47,Scroll_5Frames);  //Set the properties of Horizontal Scroll
  SeeedGrayOled.activateScroll();                   // Activate Scroll
  delay(10000);  
